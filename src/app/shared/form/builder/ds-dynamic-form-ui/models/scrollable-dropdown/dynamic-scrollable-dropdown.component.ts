  ...
  ngOnInit() {
    ...
    if (this.model.id === 'dc_relation_specialization'){
      this.sharedVariableService.currentSpecializations.subscribe((Specializations)=>{
        ...
        // if (isNotEmpty(this.newSpecializationsList)) {
        // this.newSpecializationsList.subscribe(value=>{
...
// kware-edit-end mohamed
    if (this.model.id !== 'dc_relation_specialization'){  //kware-edit mohamed
   ...
   */
  inputFormatter = (x: any): string => x.display || x.value;
